function page() {
  return (
    <div className="max-w-6xl mx-auto">
      <div className="bg-white  py-2 px-5 flex flex-col items-start font-poppins  h-full rounded-md text-xs md:text-sm ">
        <h1 className="font-semibold pt-5 pb-2 text-2xl w-full text-center">
          Privacy Policy
        </h1>
        <p className="text-justify py-1">Last updated: November 16, 2025</p>
        ...
        <ul className="list-disc p-5">
          ...
          <li>
            <p className="text-justify py-1">
              <strong>Application</strong> refers to Lumora, the software
          ...
          <li>
            <p className="text-justify py-1">
              <strong>Website</strong> refers to Lumora, accessible from{" "}
              <a
                href="www.lumora.app"
        ...
        <ul className="list-disc p-5">
          <li className="text-justify py-1">Comply with a legal obligation</li>
          <li className="text-justify py-1">
          ...
          <li className="text-justify py-1">Protect against legal liability</li>
        </ul>
        <h2 className="font-semibold text-sm ">
