...
import { PushToLiveAlertDialog } from "../(main)/course/[courseId]/_components/push-to-live-alert";
...
import { TileActionButton } from "../(main)/course/[courseId]/_components/tile-action-button";
          ...
          <CardTitle className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              <Button
                ...
                onClick={() => editCourseModal.onOpen("course", courseDetails)}
              >
              ...
              <button
                onClick={() => handleDelete(courseDetails.courseid, "course")}
                className=""
              >
                  ...
                  <CardTitle className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-3">
                      <button
                        ...
                        onClick={() => editCourseModal.onOpen("topic", topic)}
                      >
                        <Edit className="w-4 h-4" />
                      </button>
                      <button
                        className="shadow-md rounded-sm p-1 md:p-1.5"
                        onClick={() => {
                          navigator.clipboard.writeText(topic.topic_id).then(
                            function () {
                              /* clipboard successfully set */
                              toast.success("Copied topic id to clipboard");
                            },
                            function () {
                      ...
                      <button
                        onClick={() => handleDelete(topic.topic_id, "topic")}
                        className=""
                      >
                        <Trash className="w-4 h-4" />
                      </button>
                  ...
                  >
                    ...
                    {level?.related_games ? (
                      <div className=" md:pl-6 space-y-4 w-full">
                        {level?.related_games?.map((game, index: number) => (
                          <div
                            key={game.gameid}
                                ...
                                <CardTitle className="flex items-center justify-between">
                                  ...
                                  <div className="flex items-center gap-3">
                                    <button
                                      className="shadow-md rounded-sm p-1 md:p-1.5"
                                      onClick={() =>
                                        editCourseModal.onOpen("game", game)
                                      }
                                    >
                                      <Edit className="w-4 h-4" />
                                    </button>
                            ...
                            <div className="space-y-2 max-w-4xl  md:pl-5 lg:pl-8">
                              ...
                              <div className="flex justify-end ">
                                <Button
                                  ...
                                  size="sm"
                                  onClick={() =>
                                    editCourseModal.onOpen("create-tile", game)
                                  }
                                >
                                  Add Tile
                                </Button>
