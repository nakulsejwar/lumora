...
import { BookPayload, createBook } from "@/actions/library/create-book";
...
import { BlogQuizKanban } from "../blog/blog-questions-kanban";
import { BlogQuestionModal } from "../modals/blog-question-modal";
...
const formSchema = z.object({
  ...
  imgUrl: z.string({ required_error: "Please select or upload a cover image." }),
...
export function CreateBookForm() {
  ...
  async function onSubmit(data: z.infer<typeof formSchema>) {
    ...
    try {
      ...
      // If user attached a file that hasn't finished uploading
      ...
      if (!finalImgUrl) {
        loadingModal.onClose();
        return toast.error("Please upload or select a cover image for the book.");
      }

      const payload: BookPayload = {
        createdBy: {
          name: session?.user?.name || "Lumora Admin",
          image: session?.user?.image || "",
        },
        user_email: session?.user?.email || "admin@lumora.app",
        quiz: { questions: quizQuestions },
        metadata: {
          courseId: data.courseId || "",
        },
        category: data.category,
        tags: [data.category.toLowerCase(), "reading", "story"],
        title: data.title,
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="e.g. The Secret of Whispering Woods" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription>Write and format the reading text for learners.</FormDescription>
              <FormControl>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2">
                ...
                <div className="p-4 bg-white rounded-xl border border-[#c8c5d0]/70 flex flex-col justify-center">
                  ...
                  <div className="flex items-center gap-2">
                    <Input
                      placeholder="e.g. space, forest, mystery..."
                      value={searchImgKey}
        ...
        <div>
          <div>
            ...
            <p className="text-xs text-[#47464f]">
              Generate or manually add interactive questions for this book.
            </p>
          </div>
...
export const CreateBlogForm = CreateBookForm;
