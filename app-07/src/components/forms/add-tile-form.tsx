...
const tileFormSchema = z.object({
  questionTip: z.string(),
  question: z.string(),
  reason: z.string(),
  isMultiCorrect: z.boolean().default(false).optional(),
  options: z.array(optionSchema),
});

type TileFormValues = z.infer<typeof tileFormSchema>;

const defaultValues: Partial<TileFormValues> = {
  options: [
    { option: "", image: "", isSelected: false },
    { option: "", image: "", isSelected: false },
    { option: "", image: "", isSelected: false },
    { option: "", image: "", isSelected: false },
    { option: "", image: "", isSelected: false },
...
const AddTileForm = ({ game }: { game: RelatedGame }) => {
  ...
  const onSubmit = async (data: TileFormValues) => {
    ...
    updateCourse(content, {
      ...
      onSuccess: () => {
        updateCourseStore(`tileid`, `newtile`, {
          question: data.question,
          questionTip: data.questionTip,
          reason: data.reason,
          live: "yes",
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input className=" focus:!ring-transparent" {...field} />
                </FormControl>
